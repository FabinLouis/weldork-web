                    ...
                    <tbody>
                        <c:forEach var="appt" items="${appointments}">
                            <tr>
                                ...
                                <td>${appt.message}</td>
                                <td>
                                    <form action="${pageContext.request.contextPath}/admin/decision" method="post" class="d-flex gap-2">
                                        <input type="hidden" name="id" value="${appt.id}" />
                                        <input type="number" name="fee" placeholder="Fee" class="form-control" required />
                        ...
                        <c:if test="${empty appointments}">
                            <tr>
                                <td colspan="6" class="text-center text-muted">No pending appointments found.</td>
                            </tr>
                        </c:if>
                    </tbody>
                </table>
