                ...
                <div class="row gy-5 gx-0">
                    ...
                    <div class="col-lg-6 mb-n5 wow fadeIn" data-wow-delay="0.7s">
                        <div class="bg-white p-5">
                         ...
                         <form action="${pageContext.request.contextPath}/submitAppointment" method="post">
  <div class="row g-3">
    ...
    <c:choose>
        ...
        <div class="col-sm-6">
          <div class="form-floating">
            <input type="text" class="form-control border-0 bg-light" name="name"
                   value="${sessionScope.loggedInUser}" readonly>
        ...
        <div class="col-sm-6">
          <div class="form-floating">
            <input type="email" class="form-control border-0 bg-light" name="email"
                   value="${sessionScope.loggedInEmail}" readonly>
      ...
      <c:otherwise>
        <!-- Prompt to log in -->
        <div class="col-12">
          <div class="alert alert-warning text-center">Please log in to book an appointment.</div>
        </div>
      </c:otherwise>
    </c:choose>
    ...
    <div class="col-sm-6">
      <div class="form-floating">
        <input type="text" class="form-control border-0 bg-light" name="mobile" placeholder="Your Mobile">
    ...
    <div class="col-sm-6">
      <div class="form-floating">
        <select class="form-select border-0 bg-light" name="service">
          <option selected>Steel Welding</option>
          <option>Pipe Welding</option>
        </select>
    ...
    <div class="col-12">
      <div class="form-floating">
        <textarea class="form-control border-0 bg-light" name="message"
                  placeholder="Leave a message here" style="height: 130px"></textarea>
