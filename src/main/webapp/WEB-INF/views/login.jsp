...
<body>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light p-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                   ...
                   <a href="${pageContext.request.contextPath}/register" class="btn btn-outline-primary py-2 px-3 me-2">Register</a>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="bg-light p-5 rounded shadow feature-row">
                    <h2 class="fw-medium mb-4 text-center">Login</h2>
    ...
    <!-- jQuery (required before main.js) -->
